...
// Este ejercicio utiliza el metodo equals para saber si una cadena, construida con la clase String, ingresada por el usuario es igual a otra cadena ingresada por el usuario tambien construida
public class equals {
